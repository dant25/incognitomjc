...
import visitor.SymbolTableConstructor;
...
public class Incognito implements IncognitoConstants {
    public static void main(String args[]) throws ParseException
    {
        ...
        try
        {
        	...
        	root.accept(stc);
        	SymbolTable table = stc.getSymbolTable();
        	System.out.println("Incognito: Symbol Table created.");
        	
        	TypeCheckingVisitor typeChecker = new TypeCheckingVisitor();
        	typeChecker.setSymbolTable(table);
        	root.accept(typeChecker);
        	System.out.println("Incognito: Checagem de tipos concluida.");
        }
  ...
  static final public MethodDecl MethodDecl() throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
    jj_consume_token(RCURLYBRACE);
          {if (true) return new MethodDecl(type, id, formalList, varDeclList, statementList, exp);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Statement Statement() throws ParseException {
    ...
    if (jj_2_15(2)) {
      ...
      jj_consume_token(RCURLYBRACE);
          {if (true) return new Block(statementList);}
    } else if (jj_2_16(2)) {
      jj_consume_token(IF);
      jj_consume_token(L_PARENTHESIS);
      exp = Exp();
      ...
      statement2 = Statement();
          {if (true) return new If(exp, statement, statement2);}
    } else if (jj_2_17(2)) {
      ...
      jj_consume_token(R_PARENTHESIS);
      statement = Statement();
          {if (true) return new While(exp, statement);}
    } else if (jj_2_18(2)) {
      ...
      jj_consume_token(SEMICOLON);
                if(arrayassign)
                        {if (true) return new ArrayAssign(new Identifier(t.image), exp, exp2);}
                else
                        {if (true) return new Assign(new Identifier(t.image), exp2);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public Exp ExpPrime(Exp exp) throws ParseException {
        Exp exp2;
    if (jj_2_20(2)) {
      jj_consume_token(PLUS);
      exp2 = Term();
      exp2 = ExpPrime(exp2);
          {if (true) return new Plus(exp, exp2);}
    } else if (jj_2_21(2)) {
      jj_consume_token(MINUS);
      exp2 = Term();
      exp2 = ExpPrime(exp2);
          {if (true) return new Minus(exp, exp2);}
    } else {
          {if (true) return exp;}
    }
    throw new Error("Missing return statement in function");
  ...
  static final public Exp TermPrime(Exp exp) throws ParseException {
        Exp exp2;
    if (jj_2_22(2)) {
  ...
  static final public Exp Term2() throws ParseException {
        Exp exp;
    exp = Fat();
    exp = Term2Prime(exp);
          {if (true) return exp;}
  ...
  static final public Exp Term2Prime(Exp exp) throws ParseException {
        Exp exp2;
    if (jj_2_23(2)) {
      jj_consume_token(AND);
      exp2 = Fat();
      exp2 = Term2Prime(exp2);
          {if (true) return new And(exp, exp2);}
    } else if (jj_2_24(2)) {
      jj_consume_token(LESS_THAN);
      exp2 = Fat();
      exp2 = Term2Prime(exp2);
          {if (true) return new LessThan(exp, exp2);}
    } else if (jj_2_25(2)) {
  ...
  static final public Exp Fat() throws ParseException {
        Exp exp;
        Token t;
    if (jj_2_27(2)) {
  ...
  static final public Exp Fat2(Exp exp) throws ParseException {
        Token t;
        ExpList expList;
    if (jj_2_35(2)) {
      ...
      expList = ExpList();
      jj_consume_token(R_PARENTHESIS);
          {if (true) return new Call(exp, new Identifier(t.image), expList);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public Exp Fat3() throws ParseException {
        Exp exp;
        Token t;
    if (jj_2_37(2)) {
      jj_consume_token(INT);
